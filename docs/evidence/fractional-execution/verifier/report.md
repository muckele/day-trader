...
- mongo-externalPaperHarness.mongo: PASS (exit 0)
- mongo-fractionalExecution.mongo: PASS (exit 0)
...
- mongo-externalPaperHarness.mongo: VERIFIED — Required deterministic local check executed and passed
- mongo-fractionalExecution.mongo: VERIFIED — Required deterministic local check executed and passed
